    ...
    return (
        <Section className='mt-28 px-1 md:px-2 text-gray-800 dark:text-gray-50'>
            <Container className='flex flex-col gap-5'>
                <h1 className='text-4xl md:text-5xl xl:text-6xl transition font-bold'>About Us</h1>
                ...
                <div className={`flex gap-5 justify-around py-5 flex-wrap flex-col lg:flex-row`}>
